...
int conv_length(double val, char *unitname, unsigned int chainflag)
{
	...
	unit unitlist[] = {
		...
		{"l.m.", LIGHTSECOND_TO_METRE * 60, 0, {"light-minute","lightminute",""}},
		{"l.h.", LIGHTSECOND_TO_METRE * 3600, 0, {"light-hour","lighthour",""}},
		{"l.d.", LIGHTSECOND_TO_METRE * 86400, 0, {"light-day","lightday",""}},
		{"l.y.", LIGHTSECOND_TO_METRE * 86400 * 365.25, 0, {"ly","light-year","lightyear",""}},
		...
		{"fur", FOOT_TO_METRE * 660, 0, {"furlong",""}},
