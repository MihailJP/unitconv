SRC = unitconv.c length.c area.c volume.c angle.c mass.c \
      time.c force.c pressure.c energy.c power.c temp.c calc.c
OBJ = $(SRC:%.c=%.o)
TARGET = unitconv
...
volume.o: calc.h unitconv.h unitdata.h
angle.o: calc.h unitconv.h unitdata.h
mass.o: calc.h unitconv.h unitdata.h
time.o: calc.h unitconv.h unitdata.h
